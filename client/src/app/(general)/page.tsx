...
const FAQS = [
    {
        q: "What is Finfi?",
        a: "Finfi reduces user information fragmentation through the curation of a comprehensive Web3 profile, thereby simplifying transacting on-chain.",
    },
    {
            ...
            <main className="relative overflow-hidden">
                ...
                <TwoColumnSection
                    ...
                    title={
                        <>
                            Welcome To{" "}
                            <span className="text-primary">Finfi</span>
                        </>
                    }
                />
            ...
            <footer className="bg-primary">
                <div className="pt-6 pb-4">
                    <div className="max-w-screen-xl mx-auto px-4 w-full text-white flex flex-col gap-8 lg:flex-row justify-between items-center">
                        <div className="font-bold text-3xl ">Finfi</div>
                    ...
                    <div className="text-center text-white border-t border-dotted mt-6 pt-4">
                        &copy; {new Date().getFullYear()} Finfi | All rights
                        reserved.
                    </div>
                </div>
            </footer>
